      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/candidate-login" data-testid="link-candidate-login">
            <Button 
              variant="ghost" 
              className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium rounded"
          ...
          <Link href="/employer-login" data-testid="link-employer-login">
            <Button 
              className="bg-purple-800 hover:bg-purple-900 text-white px-6 font-medium rounded"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <Link href="/dashboard-selection" data-testid="link-get-started">
              <Button 
                size="lg" 
                className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 text-lg font-semibold rounded"
