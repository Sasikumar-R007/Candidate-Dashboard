...
export default function PrivacyPolicyPage() {
  const sections = useMemo(
    () =>
      Array.from(privacyPolicy.matchAll(/^##\s+(.+)$/gm), (match, index) => {
  ...
  useEffect(() => {
    ...
    const scrollRoot = document.getElementById("privacy-content-scroll");
  ...
  return (
    <PolicyPageLayout
      ...
      footerLabel="StaffOS by ScalingTheory • Privacy & Consent"
      contentScrollId="privacy-content-scroll"
      sections={sections}
      activeSlug={activeSlug}
      onSectionClick={setActiveSlug}
    >
      <PolicyMarkdownProse markdown={privacyPolicy} sections={sections} />
    </PolicyPageLayout>
  );
}
