...
export default function PlatformTermsPage() {
  ...
  return (
    <PolicyPageLayout
      ...
      footerLabel="StaffOS by ScalingTheory • Platform Terms of Use"
      contentScrollId="terms-content-scroll"
      sections={sections}
      activeSlug={activeSlug}
      onSectionClick={setActiveSlug}
    >
      <PolicyMarkdownProse markdown={platformTerms} sections={sections} />
    </PolicyPageLayout>
  );
}
