...
// Final check for candidates table truncation
...
if (content.includes(candidatesTruncatedPart)) {
  content = content.replace(candidatesTruncatedPart, candidatesFixedPart);
}

if (content.includes(insertPoint)) {
  content = content.replace(insertPoint, missingTables + insertPoint);
  fs.writeFileSync(schemaPath, content);
  console.log('Fixed missing tables and candidates table');
} else {
